    ...
    definition: {
        ...
        components: {
            schemas: {
                ...
                Club: {
                    type: "object",
                    required: ["clientId", "match1HomeTeam", "match1AwayTeam", "match2HomeTeam", "match2AwayTeam", "match1Date", "match1Hour", "match2Date", "match2Hour", "betPrice", "accumulatedPrize", "accunulatedJackpot", "limitDateForBets", "limitHourForBets", "state", "numberOfWinners", "createdAt"],
                    properties: {
                        id: {
                            type: "string",
                            description: "The auto-generated id of the lottery."
